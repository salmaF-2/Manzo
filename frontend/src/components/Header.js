        ...
        <div className='bg-white shadow-md p-6 flex justify-between items-center relative'>
            ...
            {isMobileMenuOpen && (
                <div className='absolute top-full left-0 w-full bg-white shadow-md p-4 flex flex-col space-y-4 z-50' ref={mobileMenuRef}>
                    ...
                    <Link to="/Seconnecter" className='block text-center text-white bg-[#5869A3] rounded-md px-4 py-2 hover:bg-[#48578A]'>Se connecter</Link>
                    <Link to="/CreerCompte" className='block text-center border border-[#5869A3] text-[#5869A3] rounded-md px-4 py-2 hover:bg-indigo-100'>Créer un compte</Link>
                </div>
            )}
