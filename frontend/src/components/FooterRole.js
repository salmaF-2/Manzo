...
const FooterRole = ({ isAuthenticated = false }) => {
    return (
...
// <Footer isAuthenticated={true} /> // Pour un utilisateur connecté
// <Footer isAuthenticated={false} /> // Pour un utilisateur non connec
