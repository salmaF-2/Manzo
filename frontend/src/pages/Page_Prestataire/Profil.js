    ...
    <div className="flex bg-gradient-to-br from-[#BCD0EA50] to-indigo-50 min-h-[calc(100vh-5rem)] mt-20">
      ...
      <div className="flex-1 ml-60 p-6 mt-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg mb-6 overflow-hidden transform transition-all hover:shadow-xl">
            ...
            <div className="flex items-center gap-6 p-6 -mt-14 animate-slideUp">
                {/* Image de profil */}
                <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 transform transition-all hover:scale-[1.01] hover:shadow-xl">
            ...
            <div className="flex flex-col gap-2 text-gray-600 text-sm">
              <div className="flex items-center gap-2 hover:text-blue-600 transition-colors duration-300"><FaPhoneAlt /> +212 612 0441 45</div>
              <div className="flex items-center gap-2 hover:text-blue-600 transition-colors duration-300"><FaEnvelope /> salmaiksod@gmail.com</div>
              <div className="flex items-center gap-2 hover:text-blue-600 transition-colors duration-300"><FaMapMarkerAlt /> 80000 Agadir, Maroc</div>
            </div>
          </div>
        </div>
