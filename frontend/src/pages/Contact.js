            ...
            <div className="pt-5 border-t border-gray-200 grid grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#5869A3]">@MANZO</p>
                </div>
              </div>
...
//   return (
//     <div className="min-h-screen bg-white flex flex-col mt-14 px-4 sm:px-6 lg:px-8">
//       <div className="container mx-auto px-4 py-8 flex-grow">
...
//             <div className="aspect-[4/3] w-full rounded-lg ">
//                 <img src="/images/services/image 12.png"></img>
//             </div>
//             <div className="absolute bottom-0 right-0  p-3 rounded-tl-lg">
//               <div className="w-13 h-13">
//               <img src="/images/services/image 13.png"></img>
//               </div>
//             </div>
//           </div>
//         </div>
