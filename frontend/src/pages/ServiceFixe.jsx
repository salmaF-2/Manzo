...
//                       }`}
//                     >
//                       <span className="mr-3 transition-transform group-hover:scale-125">{cat.icon}</span>
...
//                             <span className="text-2xl font-bold text-[#5869A3] animate-pulse-once">{service.price} MAD</span>
//                             <span className="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded transition-all duration-300 hover:bg-gray-200">
//                               {service.duration}
//                             </span>
//                           </div>
...
const ServiceFixe = () => {
  ...
  onClick={() => navigate(`/prestataires/service/${service._id}`, { 
    state: { 
      service: service.title,
      pricingType: 'fixed' // ou 'fixed' pour ServiceFixe
    } 
  })}
>
  Choisir le prestataire convenable
