...
//               />
//             ) : (
//               <img src="https://i.pravatar.cc/150" alt="Profil" className="w-full h-full object-cover" />
//             )}
//           </div>
    ...
    if (previewImage) {
      ...
      return (
        <div className={`w-full h-full flex items-center justify-center ${
          userData.genre === 'homme' ? 'bg-blue-100 text-blue-600' : 'bg-pink-100 text-pink-600'
        }`}>
